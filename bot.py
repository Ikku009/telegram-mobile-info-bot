...
index 8d5649e78c02f0e9c12a77febc1f3860cafd59ed..e0d94578d2143e338a237a5373b13a8984b8987f 100644
--- a/bot.py
+++ b/bot.py
@@ -17,91 +17,96 @@ load_dotenv()
 logging.basicConfig(
 ...
 📱 Examples:
-• /info +1234567890
+• /info 9876543210 (Indian local)
+• /info 09876543210 (Indian with 0)
 • /info +919876543210
 • /info +441234567890
...
+For Indian numbers, you can use any of these:
+• 9876543210
+• 09876543210
+• +919876543210
+
+For non-Indian numbers, use international format:
+• +1234567890
...
+Indian local formats are auto-converted to +91.
...
@@ -115,51 +120,51 @@ async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) ->
...
+                "Try: 9876543210, 09876543210, or +919876543210"
             )
